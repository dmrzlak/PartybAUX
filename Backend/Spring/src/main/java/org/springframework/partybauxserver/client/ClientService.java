...
public class ClientService {
	...
	public static int addClientService(ClientRepository cRepo, int client_id, int followerFK, String username, String email, String password, int partyid, int usertype) {
		...
		newClient.setfollowerFK(followerFK);
