...
public class StringRequestActivity extends Activity {
    ...
    private void makeStringReq() {
        ...
        StringRequest strReq = new StringRequest(Method.GET, "http://cs309-bs-6.misc.iastate.edu:8080", new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                Log.d(TAG, response.toString());
                msgResponse.setText("Response:\t" + response.toString());
                hideProgressDialog();
            }
